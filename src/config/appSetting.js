module.exports = {
    /* adsUploadPath: 'http://localhost/listing/ads',
    adsServerPath: 'http://localhost/listing/ads/',
    bannerUploadPath: 'http://localhost/listing/banner',
    bannerServerPath: 'http://localhost/listing/banner/',
    headerUploadPath: 'http://localhost/listing/header',
    headerServerPath: 'http://localhost/listing/header/',
    footerUploadPath: 'http://localhost/listing/footer',
    ...
    businessUserUploadPath: '/home/ubuntu/app/listing-admin-ui/listing-admin-panel/images/businessuser',
